...
class simulator_lcmt(object):
    __slots__ = ["vb", "rpy", "timesteps", "time", "quat", "R", "omegab", "omega",
                 "p", "v", "vbd", "q", "qd", "qdd", "tau", "tauAct", "f_foot", "p_foot"]

    __typenames__ = ["double", "double", "int64_t", "double", "double", "double", "double", "double",
                     "double", "double", "double", "double", "double", "double", "double", "double", "double", "double"]

    __dimensions__ = [[3], [3], None, None, [4], [9], [3], [3], [
    ...
    def _get_packed_fingerprint():
        if simulator_lcmt._packed_fingerprint is None:
            simulator_lcmt._packed_fingerprint = struct.pack(
                ">Q", simulator_lcmt._get_hash_recursive([]))
