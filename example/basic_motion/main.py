...
class Robot_Ctrl(object):
    def __init__(self):
        self.rec_thread = Thread(target=self.rec_responce)  # 接受线程
        self.send_thread = Thread(target=self.send_publish)  # 发送线程
        self.lc_r = lcm.LCM(
            "udpm://239.255.76.67:7670?ttl=255")  # 接收通道 port 7670
        self.lc_s = lcm.LCM(
            "udpm://239.255.76.67:7671?ttl=255")  # 发送通道 port 7671
